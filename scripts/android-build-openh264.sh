...
function build {
	...
	MAKE="make PATH=$PATH ENABLEPIC=Yes OS=android ANDROID_STL=libc++_shared NDKROOT=$OPENH264_NDK NDK_TOOLCHAIN_VERSION=clang TARGET=android-$2 NDKLEVEL=$2 ARCH=$1 -j libraries"
